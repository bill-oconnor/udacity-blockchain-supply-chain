...
// Import the coffeeaccesscontrol libraries
    ...
    RetailerRole
{
    ...
    function updateItemHistory(uint256 _upc, string memory txHash) public {
        itemsHistory[_upc].push(txHash); // WO: where the hell do i get the transaction hash
    }
}
